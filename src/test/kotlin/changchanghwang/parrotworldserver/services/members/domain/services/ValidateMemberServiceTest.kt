...
class ValidateMemberServiceTest {
    ...
    inner class ValidateSignUpTest {
        ...
        fun errorWhenSameEmail() {
            // given
            given(memberRepository.checkByEmail("test@test.com")).willReturn(true)
        ...
        fun errorWhenSameNickName() {
            // given
            given(memberRepository.checkByEmail("test@test.com")).willReturn(false)
            given(memberRepository.checkByNickName("testNickName")).willReturn(true)
        ...
        fun returnHashedPassword() {
            // given
            given(memberRepository.checkByEmail("test@test.com")).willReturn(false)
            given(memberRepository.checkByNickName("testNickName")).willReturn(false)
            val hashedPassword =
                validateMemberService.validateSignUp(
                    "test@test.com",
                    "testNickName",
